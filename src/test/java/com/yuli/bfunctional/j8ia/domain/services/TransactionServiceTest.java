...
public class TransactionServiceTest {
    ...
    public void able_To_Get_All_In_2011_And_Sorted_By_Value() throws Exception {
        ...
        // When
        List<Transaction> all2011 = this.transactionService.getAllSortedTransactionsIn2011();

        boolean areAllIn2011 = all2011.stream().allMatch(t -> t.getYear() == 2011);
    ...
    public void able_To_Know_All_Trader_Cities() throws Exception {
        ...
        assertThat(allCities, containsInAnyOrder("Roma", "Milan", "Cambridge"));
    }
    ...
    public void able_To_Know_All_Traders_From_Cambridge() throws Exception {
        ...
        // When
        List<Trader> allTraders = this.transactionService.getAllSortedTradersFromCambridge();

        boolean allFromCambridge = allTraders.stream().allMatch(t -> t.getCity().equals("Cambridge"));
    ...
    public void able_To_List_All_Values_From_Cambridge() throws Exception {
        ...
        // When
        List<Integer> values = this.transactionService.getAllTransactionValuesFromCambridge();
    ...
    public void able_To_Know_The_Transaction_With_Smallest_Value() throws Exception {
        ...
        // When
        Transaction transaction = this.transactionService.getTransactionWithSmallestValue();
