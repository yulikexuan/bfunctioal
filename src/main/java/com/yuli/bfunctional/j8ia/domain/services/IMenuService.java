...
/*
Names of dishes that are low in calories, sorted by number of calories. P79

Create a vegetarian menu by filtering all vegetarian dishes. P93

Filter all even numbers from a list and makes sure that there are no duplicates P94

Create a List by selecting the first three dishes that have more than 300 calories as follows P94

Skips the first two dishes that have more than 300 calories and returns the restP95

Filter the first two meat dishes P96

Extract the names of the dishes in the stream P96

Given a list of words, return a list of the number of characters for each word P96
