...
public class TransactionRepository implements ITransactionRepository {
    ...
    public List<Transaction> getAllTransactions() {
        ...
        Trader raoul = traderBuilder.clear().setName("Raoul")
                .setCity("Roma").createTrader();
        Trader mario = traderBuilder.clear().setName("Mario")
                .setCity("Milan").createTrader();
        Trader alan = traderBuilder.clear().setName("Alan")
                .setCity("Cambridge").createTrader();
        Trader brian = traderBuilder.clear().setName("Brian")
                .setCity("Cambridge").createTrader();
